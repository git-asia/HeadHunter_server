...
//     'SELECT `studentId` FROM `students` WHERE `githubUsername` = :ghUsername',
//     {
//       ghUserName,
//     },
...
//         'Podaj poprawny numer telefonu lub nie podawaj żadnego',
//       );
//     }
//
//     if (this.monthsOfCommercialExp < 0) {
//       throw new ValidationError(
//         'Długość doświadczenia musi być liczbą nieujemną',
//       );
//     }
//
...
//       await sendMail(
//         'headhunter@testHeadHunter.oi',
//         'student o id:' + studentId + ' został zatrudniony',
//         'student o id:' + studentId + ' został zatrudniony',
//       ); //@TODO do zastanowienia się jaki tekst ma być wysyłany
...
//     const [results] = await pool.execute(
//       'UPDATE `students` SET `reservedBy` = :hrId, `userStatus` = :userStatus, `reservationExpiresOn` = :reservationExpiresOn  WHERE `studentId` = :studentId',
//       { hrId, userStatus, reservationExpiresOn, studentId },
//     );
//     if (results) {
//       return message;
//     } else {
